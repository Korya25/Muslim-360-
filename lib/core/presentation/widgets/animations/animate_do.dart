...
class AppAnimations {
  ...
  static Widget staggered(
    ...
    final delay = Duration(
      milliseconds: (baseDelay?.inMilliseconds ?? 100) * index,
    );

    switch (type) {
      case 'fadeIn':
        return FadeIn(delay: delay, child: child);
      case 'slideUp':
        return SlideInUp(delay: delay, child: child);
      case 'bounceIn':
        return BounceIn(delay: delay, child: child);
      case 'zoomIn':
        return ZoomIn(delay: delay, child: child);
      case 'slideLeft':
        return SlideInLeft(delay: delay, child: child);
      case 'slideRight':
        return SlideInRight(delay: delay, child: child);
      default:
        return FadeIn(delay: delay, child: child);
    }
  }
